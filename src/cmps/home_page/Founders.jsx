...
export function Founders(props) {
    ...
    return (<div className='box-person flex column space-between'>
        ...
        <div className="box-person-content flex space-between">
            {props.persons.map((person) => {
                return (
                    <div className="founders flex column align-center" key={person.name}>
                        <object className='person-img' data={person.img} width="140" height="138"></object>
