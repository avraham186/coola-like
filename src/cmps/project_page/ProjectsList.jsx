...
const ProjectsList = () => {
  ...
  const applyProjects = () => {
    ...
    const projectCompleted = allProjects.filter(
      ({ projectStatus }) => projectStatus === "COMPLETED"
    );
    const restProject = allProjects.filter(
      ({ projectStatus }) => projectStatus !== "COMPLETED"
    );
          ...
          <tr className="projects-row ">
            ...
            <th>
              ...
              <img
                ...
                alt="arrow down"
                onClick={() =>
                  setSortHeaders((p) => ({ date: false, status: !p.status }))
                }
              />
            </th>
            <th>
              ...
              <img
                ...
                alt="arrow down"
                onClick={() =>
                  setSortHeaders((p) => ({ status: false, date: !p.date }))
                }
              />
            </th>
            <th>השלמת המשימה</th>
