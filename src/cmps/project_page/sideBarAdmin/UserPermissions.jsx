            ...
            return (
              ...
              >
                ...
                <select name="dropdownPermits" className="dropdownPermits">
                  <option value="הרשאת מתנדב">הרשאת מתנדב</option>
                  <option value="הרשאת מנהל משימה">הרשאת מנהל משימה</option>
                  <option value="הרשאת אדמין">הרשאת אדמין</option>
                  <option value="הסרת הרשאות ">הסרת הרשאות</option>
                </select>
