...
//         {jobType : 'משרה מלאה'},
//         {description : `מחפש/ת בית מקצועי בהייטק להזניק את הקריירה שלך בתחום הפיתוח?
//         במקום הכי חם בדרום - באר-שבע, נמצא מרכז הפיתוח שלנו ב- Ness מקום שמשלב טכנולוגיה מתקדמת, אווירה ואנשים מדהימים.
//         אז אם את/ה מחפש/ת עבודה במקום שגם מפתחים וגם נהנים - זה המקום המושלם עבורך!'
//        הצוות שלנו מפתח ב-JAVA מערכות מורכבות בעולם השבבים והמוליכים למחצה.`},
//        {lookingFor: 'מה אנחנו מחפשים?'},
//        {jobDemands : `אנשי/נשות פיתוח עם אהבה לאתגרים חדשים,
//        ויצירתיות שזורמת בדם - חובה!
//        השכלה אקדמית במדעים מדויקים - חובה.
//        אנגלית ברמה גבוהה - חובה. בוגר/ת`},
//        {linkTo: `קישור לעמוד המשרה : `},
//        {url: `https://app.linkatch.com/companies/ness/jobs/
